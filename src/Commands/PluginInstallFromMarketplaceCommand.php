...
use Grilar\PluginManagement\Services\MarketplaceService;
...
#[AsCommand('cms:plugin:install-from-marketplace', 'Install a plugin from https://marketplace.grilar.com')]
